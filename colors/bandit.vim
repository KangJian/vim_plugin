...
let ColourAssignment['Normal']          = {"GUIFG": '#BDB76B',       "GUIBG":  '#1E1E1E'}

" Comments are green
let ColourAssignment['Comment']         = {"GUIFG": '#01B468',     "CTERMFG": 'Green',     "TERM":   'Bold'}
...
highlight Visual     guibg=#1E2B46
highlight CursorLine guibg=#1E2B46
highlight PmenuSel   guibg=#3399FF
highlight ErrorMsg   guifg='red'   guibg='#1E1E1E'
highlight WarningMsg guifg='white' guibg='#1E1E1E'
...
let ColourAssignment['PreProc']         = {"GUIFG": '#839496',  "TERM":  'Underline'}
let ColourAssignment['Include']         = {"GUIFG": '#839496',						} " preprocessor #include
...
let ColourAssignment['Statement']       = {"GUIFG": '#47A6FF',        "TERM":    'Bold'}
let ColourAssignment['Conditional']     = {"GUIFG": '#47A6FF'} " if, then, else, endif, switch, etc.
let ColourAssignment['Repeat']          = {"GUIFG": '#47A6FF'} " for, do, while, etc.
...
let ColourAssignment['Identifier']      = {"GUIFG": '#569CD6',        "TERM":    'Underline'}
let ColourAssignment['Function']        = {"GUIFG": '#FF8000',     "CTERMFG": 'Cyan'}
let ColourAssignment['Method']          = {"GUIFG": '#FF8000',     "CTERMFG": 'Cyan'}
...
let ColourAssignment['Member']          = {"GUIFG": '#BDB76B',    "TERM":    'Underline'}
let ColourAssignment['Union']           = {"GUIFG": '#BDB76B',        "TERM":    'Underline'}
let ColourAssignment['GlobalVariable']  = {"GUIFG": '#BDB76B',     "CTERMFG": 'Cyan',      "TERM":  'Underline'}
...
let ColourAssignment['Type']            = {"GUIFG": '#569CD6',     "TERM":    'Underline'}
let ColourAssignment['StorageClass']    = {"GUIFG": '#ff4040'} " static, register, volatile, etc.
let ColourAssignment['Structure']       = {"GUIFG": '#FF8000'} " struct, union, enum, etc.

" Special Stuff
let ColourAssignment['Special']         = {"GUIFG": '#569CD6',         "TERM":    'Bold'}
let ColourAssignment['SpecialChar']     = {"GUIFG": '#569CD6'}     " special character in a constant
...
let ColourAssignment['NonIndentTabError']={"GUISP": 'White',     "GUI":   'undercurl',   "CTERMBG": 'Red'}

" Stuff needing doing
let ColourAssignment['Todo']            = {"GUIFG": 'Blue',        "GUIBG":   'White',    "TERM":  'Standout'}

" Folding
let ColourAssignment['FoldColumn']      = {"GUIFG": 'DarkBlue',    "GUIBG":   'Gray'}

" Popup Menu
let ColourAssignment['Pmenu']           = {"GUIFG": '#BDB76B',     "GUIBG": '#1E1E1E',     "CTERMFG": "Black",   "CTERMBG": "Yellow"}
...
let ColourAssignment['StatusLine']      = {"GUIFG": 'Black',       "GUIBG": 'LightGrey'} 
let ColourAssignment['StatusLineNC']    = {"GUIFG": 'Black',       "GUIBG": 'White'}
